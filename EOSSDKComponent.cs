...
namespace EpicTransport
{
    ...
    public class EOSSDKComponent : MonoBehaviour
    {
        ...
        [SerializeField] private EosApiKey apiKeys;
        ...
        [Header("Misc")] public LogLevel epicLoggerLevel = LogLevel.Error;

        [SerializeField] private bool collectPlayerMetrics = true;

        public static bool CollectPlayerMetrics
        {
            get { return Instance.collectPlayerMetrics; }
        }
        ...
        public static Epic.OnlineServices.Metrics.MetricsInterface GetMetricsInterface() =>
            Instance.EOS.GetMetricsInterface(); // Handled by the transport automatically, only use this interface if Mirror is not used for singleplayer
        ...
        {
            get { return Instance.localUserAccountId; }
        }
        ...
        {
            get { return Instance.localUserAccountIdString; }
        }
        ...
        {
            get { return Instance.localUserProductId; }
        }
        ...
        {
            get { return Instance.localUserProductIdString; }
        }
        ...
        {
            get { return Instance.isConnecting; }
        }
...
#if UNITY_EDITOR && PLATFORM_LINUX
            libraryPointer = LoadLibrary(Config.LibraryName);
            if (libraryPointer == IntPtr.Zero)
            {
                throw new Exception("Failed to load library" + Config.LibraryName);
            }
        ...
        private void OnConnectInterfaceLogin(Epic.OnlineServices.Connect.LoginCallbackInfo loginCallbackInfo)
        {
            ...
            {
                Debug.Log("Login returned " + loginCallbackInfo.ResultCode + "\nRetrying...");
                EOS.GetConnectInterface().CreateUser(new Epic.OnlineServices.Connect.CreateUserOptions() {ContinuanceToken = loginCallbackInfo.ContinuanceToken}, null,
                    (Epic.OnlineServices.Connect.CreateUserCallbackInfo cb) =>
                    {
