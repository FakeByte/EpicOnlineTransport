    ...
    public class EOSSDKComponent : MonoBehaviour
    {
        ...
        protected void InitializeImplementation()
        {
            ...
            if (authInterfaceLogin)
            {
                ...
                Debug.Log("EOS: Attempting iOS Auth login");
                Epic.OnlineServices.Auth.IOSLoginOptions modifiedLoginOptions = EOS_iOSLoginOptionsHelper.MakeIOSLoginOptionsFromDefualt(loginOptions);
                EOS.GetAuthInterface().Login(modifiedLoginOptions, null, OnAuthInterfaceLogin);
#else
                Debug.Log("EOS: Attempting regular Auth login");
