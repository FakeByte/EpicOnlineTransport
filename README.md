...
2. In Unity -> Project Settings -> Player -> Other Settings -> Scripting define symbols set PLATFORM_64BITS for Win64 or PLATFORM_32BITS for Win32
2.1 For other platforms see Epic.OnlineServices.Config in the SDK for their defines
